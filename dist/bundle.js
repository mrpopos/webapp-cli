...
var hasRequiredIsFullwidthCodePoint$1;
...
function requireWrapAnsi$1 () {
	...
	const stringWidth = requireStringWidth$1();
	const stripAnsi = requireStripAnsi$1();
...
var wrapAnsiExports = requireWrapAnsi$1();
...
var hasRequiredAnsiEscapes$1;

function requireAnsiEscapes$1 () {
	if (hasRequiredAnsiEscapes$1) return ansiEscapes$2.exports;
	hasRequiredAnsiEscapes$1 = 1;
	(function (module) {
	...
	return ansiEscapes$2.exports;
}

var ansiEscapesExports = requireAnsiEscapes$1();
var ansiEscapes$1 = /*@__PURE__*/getDefaultExportFromCjs(ansiEscapesExports);

const height = (content) => content.split('\n').length;
const lastLine = (content) => content.split('\n').pop() ?? '';
function cursorDown(n) {
    return n > 0 ? ansiEscapes$1.cursorDown(n) : '';
}
class ScreenManager {
    rl;
    ...
    render(content, bottomContent = '') {
        ...
        if (bottomContentHeight > 0)
            output += ansiEscapes$1.cursorUp(bottomContentHeight);
        // Return cursor to the initial left offset.
        output += ansiEscapes$1.cursorTo(this.cursorPos.cols);
        /**
         * Render and store state for future re-rendering
         */
        this.write(cursorDown(this.extraLinesUnderPrompt) +
            ansiEscapes$1.eraseLines(this.height) +
            output);
    ...
    checkCursorPos() {
        ...
        if (cursorPos.cols !== this.cursorPos.cols) {
            this.write(ansiEscapes$1.cursorTo(cursorPos.cols));
        ...
        output += clearContent ? ansiEscapes$1.eraseLines(this.height) : '\n';
        output += ansiEscapes$1.cursorShow;
        this.write(output);
        this.rl.close();
    }
}
...
var select = createPrompt((config, done) => {
    ...
    const choiceDescription = selectedChoice.description
        ...
        : ``;
    return `${[prefix, message, helpTipTop].filter(Boolean).join(' ')}\n${page}${helpTipBottom}${choiceDescription}${ansiEscapes$1.cursorHide}`;
});
...
function requireSrc$1 () {
	...
	hasRequiredSrc$1 = 1;
	(function (exports) {
		var __importDefault = (src$2.__importDefault) || function (mod) {
...
var debug = /*@__PURE__*/getDefaultExportFromCjs(srcExports$1);
...
var PluginStore = class {
  constructor() {
    ...
    this.events = new require$$0$1.EventEmitter();
  }
  on(type, listener) {
...
function requireMimicFn () {
	if (hasRequiredMimicFn) return mimicFn;
...
function requireIsFullwidthCodePoint () {
	if (hasRequiredIsFullwidthCodePoint) return isFullwidthCodePoint;
	hasRequiredIsFullwidthCodePoint = 1;
	/* eslint-disable yoda */
	isFullwidthCodePoint = x => {
		if (Number.isNaN(x)) {
			return false;
		}
...
function requireLogUpdate () {
	if (hasRequiredLogUpdate) return logUpdate.exports;
	...
	logUpdate.exports = main(process.stdout);
	logUpdate.exports.stderr = main(process.stderr);
	logUpdate.exports.create = main;
	return logUpdate.exports;
}
...
function requireHumanize () {
	if (hasRequiredHumanize) return humanize;
...
var estimates;
var hasRequiredEstimates;

function requireEstimates () {
	if (hasRequiredEstimates) return estimates;
	hasRequiredEstimates = 1;

	const { existsSync, mkdirSync, readFileSync, writeFileSync } = require$$0$6;
...
function requireLogger () {
	...
	const { humanizeActual, humanizeRemaining } = requireHumanize();
	const { getEstimate, updateEstimate } = requireEstimates();
	const { getProgressBar } = requireProgress();
...
function requireTemplates$1 () {
	if (hasRequiredTemplates$1) return templates$2;
...
function requireTheme () {
	if (hasRequiredTheme) return theme_1;
	hasRequiredTheme = 1;
...
var createLogger = /*@__PURE__*/getDefaultExportFromCjs(srcExports);
